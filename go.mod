module github.com/ironcladlou/prowdb
...
require (
	...
	k8s.io/test-infra v0.0.0-20220113183230-6d54c6eacc2f
	zombiezen.com/go/sqlite v0.9.0-beta1.0.20220117162518-bc594c98907a
)
